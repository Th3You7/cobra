import 'package:cobra/core/models/channel.dart';
...
import '../../features/streaming/presentation/pages/content_detail_page.dart';
import '../../features/streaming/presentation/pages/live_page.dart';
import '../../features/streaming/presentation/pages/movies_page.dart';
import '../../features/streaming/presentation/pages/player_page.dart';
...
import '../../features/streaming/presentation/widgets/streaming_theme.dart';
...
class AppRouter {
  static final appRouter = GoRouter(
    ...
    routes: [
      ...
      ShellRoute(
        builder: (context, state, child) => StreamingShell(state: state, child: child),
        routes: [
          GoRoute(
            ...
            routes: [
              ...
              GoRoute(
                path: 'content/detail',
                name: 'Content Detail',
                builder: (context, state) => ContentDetailPage(channel: state.extra as Channel?),
              ),
              GoRoute(
                path: 'catchup',
                name: 'Catch Up',

...
/// Movies: same layout as Live — top bar (Movies tab), left sidebar (categories), grid of movie cards.
...
class _MoviesPageState extends ConsumerState<MoviesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final channelsAsync = ref.watch(movieChannelsProvider);
  ...
  Widget _buildSidebar(
    ...
    final items = <_SidebarItem>[
      _SidebarItem(id: null, name: 'Resume to Watch', count: 0),
...
class _MovieCard extends StatelessWidget {
  const _MovieCard({required this.channel, required this.onTap});
  ...
  Widget _placeholder(ThemeData theme) {
    return Container(
      ...
      child: Icon(Icons.movie, size: 48, color: theme.colorScheme.primary),
    );
  }
}
